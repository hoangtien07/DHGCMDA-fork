# AGENTS.md — DHGCMDA-fork project context

> File này được Codex đọc tự động khi mở project. Mục đích: giúp lần làm việc sau bắt đầu ngay không phải dò lại setup.
...
Seed 1234, đơn điệu tới tận K=1: K13=0.6311 < K7=0.6538 < K3=0.6808 < **K2=0.6940** < **K1=0.6978**.

### K=2 multi-seed — BEST hợp lệ mới (vượt K=3, ổn định hơn)
| Seed | 1234 | 0 | 42 | **Mean±std** | AUC |
|---|---:|---:|---:|---:|---:|
| K=2 | 0.6940 | 0.7008 | 0.6974 | **0.6974 ± 0.0034** | 0.9818 |
- **K=2 0.6974 > K=3 0.6883** (+0.9pt), std chặt hơn 3× (0.0034 vs 0.0107). So paper 0.5970 → **+16.8%**. Mọi seed K=2 vượt *mean* K=3.
- Không công bố lucky seed 0.7008 riêng lẻ (giữ kỷ luật). Caveat in-sample-CV như K=3 nhưng replicate 2 seed ngoài selection.
...
Nội dung báo cáo gồm 4 phần: Tổng quan + Phân tích phương pháp / Kết quả + Phê bình / Báo cáo Reproduce / Hướng mở rộng. Plan đã chốt nằm tại `C:\Users\hungld\.Codex\plans\download-code-v-data-async-lovelace.md`.
...
Lưu ở `C:\Users\hungld\.Codex\plans\download-code-v-data-async-lovelace.md`. Đọc lại nếu cần align scope.
